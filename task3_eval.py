...
def main():
    ...
    parser.add_argument("--results", type=str, default="outputs/task2_llm_results.json",
    ...
    out_jsonl = "outputs/task3_eval.jsonl"
    out_md = "outputs/task3_examples.md"
    out_reflect = "outputs/task3_reflection.md"
